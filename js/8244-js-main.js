; (function () {
	...
	var contactForm = function () {
		(function ($, window, document, undefined) {
			...
			$form.submit(function (e) {
				...
				// get the form data
				const name = $('input[name="form-name"]').val();
				const email = $('input[name="form-email"]').val();
				const message = $('textarea[name="form-message"]').val();
				const phone = $('textarea[name="form-phone"]').val();
				
				window.open(`mailto:shaadiwalee01@gmail.com?subject=ContactFrom&body=Hey my name is ${name} and email address ${email}. Message=${message}. Phone Number=${phone}`);
				e.preventDefault();
			});
	...
	var countdown = function () {
		...
		var deadline = 'October 18 2015 17:30:00 GMT+0300';
		if (countdown) {
